...
function tratar_eventos() {
    ...
    //botão esconder (cancelar) o cadastro de contato
    ...
    document.getElementById("form-contato").onsubmit = function () {
        ...
        img_remove.setAttribute('src', 'assets/img/cross.png');
        ...
        img_avatar.setAttribute('src', 'assets/img/' + this.avatar_selecionado.value);
        ...
        td_nome.appendChild(document.createTextNode(email));

        var td_telefone = document.createElement("td");
        td_nome.appendChild(document.createTextNode(telefone));

        var td_cidade = document.createElement("td");
        td_nome.appendChild(document.createTextNode(cidade));
